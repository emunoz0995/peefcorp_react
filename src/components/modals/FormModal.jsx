...
const FormModal = ({year}) => {
    ...
    return (
        <>
            ...
            <dialog id="my_modal_3" className={`bg-gray-600/40 backdrop-blur-sm absolute top-0 w-full h-screen justify-center ${openModal ? "flex" : "hidden"} `}>
